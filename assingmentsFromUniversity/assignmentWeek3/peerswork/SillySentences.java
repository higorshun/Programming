/*
  ...
  This program implements these rules to generate random sentences.  All of the sentences make no
  sense (but still follow the syntax).  
...
public class SillySentences {
    ...
    static final String[] adjective = {"big", "pretty", "tiny", "bald"};


    static final String[] intransitive_verb = {"runs", "jumps", "talks", "sleeps"};


    static final String[] transitive_verb = {"loves", "hates", "sees", "knows", "looks", "looks for", "finds"};

...
public class randomSentences {
    ...
    static final String[] properNoun = {"Fred", "Jane", "Richard Nixon", "Miss America", "Bozo", "Manuel", "Pedro", "Pierre"};
    static final String[] commonNoun = {"man", "woman", "fish", "elephant", "unicorn"};
    static final String[] determiner = {"a", "the", "every", "some", "few", "many"};
    static final String[] adjective = {"big", "tiny", "pretty", "bald", "yellow", "red", "difficult", "sweet", "lovely", "tall", "slow"};

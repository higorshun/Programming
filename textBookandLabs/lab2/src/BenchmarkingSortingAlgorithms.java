...
public class BenchmarkingSortingAlgorithms {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Time to sort " + length + " numbers in Array1 = " + (amountOfTimeToRunTheFirstArray) + " " +
                "milliseconds.");
        ...
        // print out the result on console
        System.out.println("Time to sort " + length + " numbers in Array2 = " + (amountOfTimeToRunTheSecondArray) +
                " milliseconds.");

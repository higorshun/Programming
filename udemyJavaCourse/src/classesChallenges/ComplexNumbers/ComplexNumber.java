package classesChallenges.ComplexNumbers;
...
public class ComplexNumber {
    ...
    public void add(ComplexNumber complexNumber) {
        ...
        double complexAddImaginary = complexNumber.imaginary + getImaginary();
        this.imaginary = complexAddImaginary;
    ...
    public void subtract(ComplexNumber complexNumber){
        ...
        this.imaginary = complexSubstractionImaginary;

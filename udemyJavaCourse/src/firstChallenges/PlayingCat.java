package firstChallenges;/*The cats spend most of the day playing. In particular, they play if the temperature is
...
2nd parameter represents the temperature and is of type int with the name temperature.
        ...
        * isCatPlaying(false, 36); should return false since temperature is not in range 25 - 35 (summer parameter is
         false)

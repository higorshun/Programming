...
public class Demo {
    ...
    private static void printList(LinkedList<String> linkedList) {
        ...
        while (i.hasNext()) {
            System.out.println("Now visiting " + i.next()); // same as i++
        }
        System.out.println("===========================");
    }
    ...
    public static boolean addInOrder(LinkedList<String> linkedList, String newCity) {
        ...
        while (stringListIterator.hasNext()) {
            ...
            if (comparison == 0) {
                ...
                // Brisbane -> Adelaide
                stringListIterator.previous(); // go back to the record
        ...
        stringListIterator.add(newCity);
        return true; //after testing everything is ok
    }
        ...
        while (!quit) {
            ...
            switch (action) {
                ...
                case 2:
                    ...
                    if (listIterator.hasPrevious()) {
                        System.out.println("Now vising " + listIterator.previous());
                    } else {
